    ...
    const pageContent = {
        home: `
            <div id="home-content" class="text-center py-12">
                <h2 class="text-[var(--primary-color)] text-4xl font-extrabold leading-tight tracking-[-0.02em] mb-4">Jupiter's Pies - Out of This World Pastries</h2>
                <p class="text-[var(--text-dark)] text-lg font-medium leading-relaxed max-w-sm mx-auto mb-8">
                    Myrtle Beach's premier pastry destination featuring signature pies and heavenly desserts!
                </p>
                <img src="assets/images/jupiter-pies-home.jpg" alt="Assortment of fresh pies and pastries" class="w-full h-64 object-cover rounded-lg shadow-lg mx-auto mb-8">
        ...
        menu: `
            <div class="overflow-x-auto whitespace-nowrap border-b border-[var(--border-color)] px-4">
                <nav class="flex gap-6">
                    <a class="inline-block border-b-2 border-b-[var(--primary-color)] text-[var(--text-dark)] pb-3 pt-2 text-sm font-bold" href="#signature-pies-section" data-menu-category="signature-pies">Signature Pies</a>
                    <a class="inline-block border-b-2 border-b-transparent text-[var(--text-medium)] pb-3 pt-2 text-sm font-medium hover:text-[var(--text-dark)] transition-colors" href="#pastries-section" data-menu-category="pastries">Pastries</a>
                    <a class="inline-block border-b-2 border-b-transparent text-[var(--text-medium)] pb-3 pt-2 text-sm font-medium hover:text-[var(--text-dark)] transition-colors" href="#tarts-section" data-menu-category="tarts">Tarts</a>
                    <a class="inline-block border-b-2 border-b-transparent text-[var(--text-medium)] pb-3 pt-2 text-sm font-medium hover:text-[var(--text-dark)] transition-colors" href="#desserts-section" data-menu-category="desserts">Desserts</a>
                    <a class="inline-block border-b-2 border-b-transparent text-[var(--text-medium)] pb-3 pt-2 text-sm font-medium hover:text-[var(--text-dark)] transition-colors" href="#beverages-section" data-menu-category="beverages">Beverages</a>
                </nav>
            </div>

            <div class="px-4 pt-6 pb-24">
                <h2 id="signature-pies-section" class="text-[var(--text-dark)] text-2xl font-bold leading-tight tracking-[-0.015em] mb-4 mt-6">Signature Pies</h2>
                <div class="space-y-4">
                    <div class="flex items-start justify-between gap-4 py-4 border-b border-[var(--border-color)]">
                        <div class="flex flex-col gap-1 flex-1">
                            <h3 class="text-[var(--text-dark)] text-lg font-bold leading-tight">Classic Apple Pie</h3>
                            <p class="text-[var(--text-medium)] text-sm mb-1">Our signature apple pie made with Granny Smith apples, cinnamon, and our flaky butter crust</p>
                            <p class="text-[var(--text-dark)] text-base font-bold mt-2">$18.99</p>
                        </div>
                        <div class="relative">
                            <div class="menu-item-image bg-cover bg-center" style='background-image: url("https://images.unsplash.com/photo-1621955964441-c173e01c135b?w=112&h=112&fit=crop&crop=center");'></div>
                            <button class="add-to-cart-btn absolute -bottom-2 -right-2 flex items-center justify-center size-8 rounded-full bg-[var(--primary-color)] text-white shadow-lg hover:bg-opacity-90 transition-all"
                                data-item-id="classic-apple-pie" data-item-name="Classic Apple Pie" data-item-price="18.99">
                    ...
                    <div class="flex items-start justify-between gap-4 py-4 border-b border-[var(--border-color)]">
                        <div class="flex flex-col gap-1 flex-1">
                            <h3 class="text-[var(--text-dark)] text-lg font-bold leading-tight">Chocolate Silk Pie</h3>
                            <p class="text-[var(--text-medium)] text-sm mb-1">Rich chocolate custard in a graham cracker crust, topped with fresh whipped cream</p>
                            <p class="text-[var(--text-dark)] text-base font-bold mt-2">$22.99</p>
                        </div>
                        <div class="relative">
                            <div class="menu-item-image bg-cover bg-center" style='background-image: url("https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=112&h=112&fit=crop&crop=center");'></div>
                            <button class="add-to-cart-btn absolute -bottom-2 -right-2 flex items-center justify-center size-8 rounded-full bg-[var(--primary-color)] text-white shadow-lg hover:bg-opacity-90 transition-all"
                                data-item-id="chocolate-silk-pie" data-item-name="Chocolate Silk Pie" data-item-price="22.99">
                                <svg fill="currentColor" height="20px" viewBox="0 0 256 256" width="20px" xmlns="http://www.w3.org/2000/svg"><path d="M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z"></path></svg>
                            </button>
                        </div>
                    </div>
                    <div class="flex items-start justify-between gap-4 py-4 border-b border-[var(--border-color)]">
                        <div class="flex flex-col gap-1 flex-1">
                            <h3 class="text-[var(--text-dark)] text-lg font-bold leading-tight">Key Lime Pie</h3>
                            <p class="text-[var(--text-medium)] text-sm mb-1">Tangy key lime custard in a buttery graham crust, garnished with lime zest</p>
                            <p class="text-[var(--text-dark)] text-base font-bold mt-2">$19.99</p>
                        </div>
                        <div class="relative">
                            <div class="menu-item-image bg-cover bg-center" style='background-image: url("https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=112&h=112&fit=crop&crop=center");'></div>
                            <button class="add-to-cart-btn absolute -bottom-2 -right-2 flex items-center justify-center size-8 rounded-full bg-[var(--primary-color)] text-white shadow-lg hover:bg-opacity-90 transition-all"
                                data-item-id="key-lime-pie" data-item-name="Key Lime Pie" data-item-price="19.99">
                                <svg fill="currentColor" height="20px" viewBox="0 0 256 256" width="20px" xmlns="http://www.w3.org/2000/svg"><path d="M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z"></path></svg>
                            </button>
                        </div>
                    </div>
                ...
                <h2 id="pastries-section" class="text-[var(--text-dark)] text-2xl font-bold leading-tight tracking-[-0.015em] mb-4 mt-8">Pastries</h2>
                <div class="space-y-4">
                    <div class="flex items-start justify-between gap-4 py-4 border-b border-[var(--border-color)]">
                        <div class="flex flex-col gap-1 flex-1">
                            <h3 class="text-[var(--text-dark)] text-lg font-bold leading-tight">Chocolate Croissants</h3>
                            <p class="text-[var(--text-medium)] text-sm mb-1">Buttery croissants filled with Belgian dark chocolate</p>
                            <p class="text-[var(--text-dark)] text-base font-bold mt-2">$4.99</p>
                        </div>
                        <div class="relative">
                            <div class="menu-item-image bg-cover bg-center" style='background-image: url("https://images.unsplash.com/photo-1555507036-ab794f4afe5e?w=112&h=112&fit=crop&crop=center");'></div>
                            <button class="add-to-cart-btn absolute -bottom-2 -right-2 flex items-center justify-center size-8 rounded-full bg-[var(--primary-color)] text-white shadow-lg hover:bg-opacity-90 transition-all"
                                data-item-id="chocolate-croissants" data-item-name="Chocolate Croissants" data-item-price="4.99">
                                <svg fill="currentColor" height="20px" viewBox="0 0 256 256" width="20px" xmlns="http://www.w3.org/2000/svg"><path d="M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z"></path></svg>
                            </button>
                        </div>
                    </div>
                    <div class="flex items-start justify-between gap-4 py-4 border-b border-[var(--border-color)]">
                        <div class="flex flex-col gap-1 flex-1">
                            <h3 class="text-[var(--text-dark)] text-lg font-bold leading-tight">Blueberry Tart</h3>
                            <p class="text-[var(--text-medium)] text-sm mb-1">Fresh blueberry tart with vanilla pastry cream and buttery crust</p>
                            <p class="text-[var(--text-dark)] text-base font-bold mt-2">$6.99</p>
                        </div>
                        <div class="relative">
                            <div class="menu-item-image bg-cover bg-center" style='background-image: url("https://images.unsplash.com/photo-1464349095431-e9a21285b5f3?w=112&h=112&fit=crop&crop=center");'></div>
                            <button class="add-to-cart-btn absolute -bottom-2 -right-2 flex items-center justify-center size-8 rounded-full bg-[var(--primary-color)] text-white shadow-lg hover:bg-opacity-90 transition-all"
                                data-item-id="blueberry-tart" data-item-name="Blueberry Tart" data-item-price="6.99">
                                <svg fill="currentColor" height="20px" viewBox="0 0 256 256" width="20px" xmlns="http://www.w3.org/2000/svg"><path d="M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z"></path></svg>
                            </button>
                        </div>
                    </div>
                    <div class="flex items-start justify-between gap-4 py-4">
                        <div class="flex flex-col gap-1 flex-1">
                            <h3 class="text-[var(--text-dark)] text-lg font-bold leading-tight">Cinnamon Rolls</h3>
                            <p class="text-[var(--text-medium)] text-sm mb-1">Warm cinnamon rolls with cream cheese glaze, baked fresh daily</p>
                            <p class="text-[var(--text-dark)] text-base font-bold mt-2">$5.99</p>
                        </div>
                        <div class="relative">
                            <div class="menu-item-image bg-cover bg-center" style='background-image: url("https://images.unsplash.com/photo-1509440159596-0249088772ff?w=112&h=112&fit=crop&crop=center");'></div>
                            <button class="add-to-cart-btn absolute -bottom-2 -right-2 flex items-center justify-center size-8 rounded-full bg-[var(--primary-color)] text-white shadow-lg hover:bg-opacity-90 transition-all"
                                data-item-id="cinnamon-rolls" data-item-name="Cinnamon Rolls" data-item-price="5.99">
                                <svg fill="currentColor" height="20px" viewBox="0 0 256 256" width="20px" xmlns="http://www.w3.org/2000/svg"><path d="M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z"></path></svg>
                            </button>
                        </div>
                    </div>
                ...
                <h2 id="beverages-section" class="text-[var(--text-dark)] text-2xl font-bold leading-tight tracking-[-0.015em] mb-4 mt-8">Beverages</h2>
                <div class="space-y-4">
                    <div class="flex items-start justify-between gap-4 py-4 border-b border-[var(--border-color)]">
                        <div class="flex flex-col gap-1 flex-1">
                            <h3 class="text-[var(--text-dark)] text-lg font-bold leading-tight">Fresh Brewed Coffee</h3>
                            <p class="text-[var(--text-medium)] text-sm mb-1">Premium coffee blend, perfectly paired with our pastries</p>
                            <p class="text-[var(--text-dark)] text-base font-bold mt-2">$3.99</p>
                        </div>
                        <div class="relative">
                            <div class="menu-item-image bg-cover bg-center" style='background-image: url("https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=112&h=112&fit=crop&crop=center");'></div>
                            <button class="add-to-cart-btn absolute -bottom-2 -right-2 flex items-center justify-center size-8 rounded-full bg-[var(--primary-color)] text-white shadow-lg hover:bg-opacity-90 transition-all"
                                data-item-id="fresh-brewed-coffee" data-item-name="Fresh Brewed Coffee" data-item-price="3.99">
                                <svg fill="currentColor" height="20px" viewBox="0 0 256 256" width="20px" xmlns="http://www.w3.org/2000/svg"><path d="M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z"></path></svg>
                            </button>
                        </div>
                    </div>
                    <div class="flex items-start justify-between gap-4 py-4 border-b border-[var(--border-color)]">
                        <div class="flex flex-col gap-1 flex-1">
                            <h3 class="text-[var(--text-dark)] text-lg font-bold leading-tight">Hot Chocolate</h3>
                            <p class="text-[var(--text-medium)] text-sm mb-1">Rich Belgian hot chocolate topped with whipped cream</p>
                            <p class="text-[var(--text-dark)] text-base font-bold mt-2">$4.99</p>
                        </div>
                        <div class="relative">
                            <div class="menu-item-image bg-cover bg-center" style='background-image: url("https://images.unsplash.com/photo-1542990253-a3a0d215cbba?w=112&h=112&fit=crop&crop=center");'></div>
                            <button class="add-to-cart-btn absolute -bottom-2 -right-2 flex items-center justify-center size-8 rounded-full bg-[var(--primary-color)] text-white shadow-lg hover:bg-opacity-90 transition-all"
                                data-item-id="hot-chocolate" data-item-name="Hot Chocolate" data-item-price="4.99">
                                <svg fill="currentColor" height="20px" viewBox="0 0 256 256" width="20px" xmlns="http://www.w3.org/2000/svg"><path d="M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z"></path></svg>
                            </button>
                        </div>
                    </div>
